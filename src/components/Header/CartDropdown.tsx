        ...
        <div className="ml-4 flex flex-1 flex-col">
          <div>
            <div className="flex justify-between ">
              ...
              <Prices price={price} className="mt-0.5" paymentToken={paymentToken} />
            </div>
          </div>
        ...
        <>
          ...
          >
            <div className="w-3.5 h-3.5 flex items-center justify-center bg-primary-500 absolute top-1.5 right-1.5 rounded-full text-[10px] leading-none text-white font-medium">
              <span className="mt-[1px]">{cart?.line_items.reduce((prev, cur, items) => prev + cur.quantity, 0)}</span>
            </div>
            <svg
              className="w-6 h-6"
              viewBox="0 0 24 24"
                ...
                <div className="relative bg-white dark:bg-neutral-800">
                  ...
                  <div className="bg-neutral-50 dark:bg-slate-900 p-5">
                    <p className="flex justify-between font-semibold text-slate-900 dark:text-slate-100">
                      ...
                      <span className="">{subtotal.toLocaleString()} {paymentToken}</span>
                    </p>
